...
airquality2$Sampling_point <- as.character(airquality2$Sampling_point)
...
write_xlsx(airquality2, "Cleaned_Airquality2018.xlsx")

#Write AQI to excel file
write_xlsx(Max_AQI, "Cleaned_AQI2018.xlsx")
